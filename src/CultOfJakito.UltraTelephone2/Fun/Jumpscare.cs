...
namespace CultOfJakito.UltraTelephone2.Fun
{
    ...
    public class Jumpscare : MonoBehaviour
    {
        ...
        private static string s_jumpscarePicsPath => Path.Combine(UT2Paths.TextureFolder);
...
ValidateBuiltInImage(Path.Combine(s_jumpscarePicsPath, "cover2 (4).jpg"), Properties.Resources.cover2_4);
...
ValidateBuiltInImage(Path.Combine(s_jumpscarePicsPath, "dog-stare-zoom.png"), Properties.Resources.dog-stare-zoom);
...
ValidateBuiltInImage(Path.Combine(s_jumpscarePicsPath, "Fx-3ZYsWcAIDlzG.jpg"), Properties.Resources.Fx-3ZYsWcAIDlzG);
...
ValidateBuiltInImage(Path.Combine(s_jumpscarePicsPath, "maxresdefault (44).jpg"), Properties.Resources.maxresdefault_44);
...
ValidateBuiltInImage(Path.Combine(s_jumpscarePicsPath, "SmartSelect_20211116-174331.jpg"), Properties.Resources.SmartSelect_20211116-174331);
ValidateBuiltInImage(Path.Combine(s_jumpscarePicsPath, "SmartSelect_20211125-164814.jpg"), Properties.Resources.SmartSelect_20211125-164814);
ValidateBuiltInImage(Path.Combine(s_jumpscarePicsPath, "SmartSelect_s20210321-152814.jpg"), Properties.Resources.SmartSelect_s20210321-152814);
...
ValidateBuiltInImage(Path.Combine(s_jumpscarePicsPath, "unnamed (4).jpg"), Properties.Resources.unnamed_4);
...
ValidateBuiltInImage(Path.Combine(s_jumpscarePicsPath, "artworks-dgGS7o4DGuYHt1xX-IjeBqw-t500x500.jpg"), Properties.Resources.artworks-dgGS7
        }
    }
}
