...
internal class HrtBurgers : ChaosEffect
{
    ...
    {
        s_estrogenBurger = UT2Assets.ZelzmiyBundle.GetAsset<GameObject>("estrogen burger");
        s_testosteroneBurger = UT2Assets.ZelzmiyBundle.GetAsset<GameObject>("testosterone burger");
    }
